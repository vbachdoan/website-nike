        ...
        return(
            <>
                <div className="wrap-question-box">
                    ...
                    <label for="ques1">
                        <svg aria-hidden="true" class="nds-summary-control" focusable="false" viewBox="0 0 16 16" role="img" width="16px" height="16px" fill="none"><path stroke="currentColor" d="M12.644 5.65L8 10.295 3.355 5.65"></path></svg>
