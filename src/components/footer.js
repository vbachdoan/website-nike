            ...
            <>
                <div id="wrap-footer">
                    <div id="navigation">
                        <div id="links">
                            <div id="main-links">
                                <a href="./" className="important">GIFT CARDS</a>
                                <a href="./" className="important">PROMOTIONS</a>
                                <a href="./" className="important">FIND A STORE</a>
                                <a href="./" className="important">SIGN UP FOR EMAIL</a>
                                <a href="./" className="important">BECOME A MEMBER</a>
                                <a href="./" className="important">NIKE JOURNAL</a>
                                <a href="./" className="important">SEND US FEEDBACK</a>
                            </div>
                            <div id="get-help">
                                <a href="./" className="important" style={{color: "#fff"}}>GET HELP</a>
                            ...
                            <div id="about-nike">
                                <a href="./" className="important" style={{color: "#fff"}}>ABOUT NIKE</a>
                                <a href="./">News</a>
                                <a href="./">Careers</a>
                                <a href="./">Investors</a>
                                <a href="./">Purpose</a>
                    ...
                    <div id="policy">
                        <div id="copyright">
                            ...
                            <div id="detail-copyright"><p>© 2021 Nike, Inc. All Rights Reserved</p></div>
                        </div>
                        <div id="other-links">
                            <div><a href="./guide">Guides</a></div>
                            <div><a href="/">Terms Of sale</a></div>
                            <div><a href="/">Terms Of Use</a></div>
                            <div><a href="/">Nike Privacy Policy</a></div>
                            <div><a href="/">CA Supply Chains Act</a></div>
                        </div>
                    </div>
                </div>
